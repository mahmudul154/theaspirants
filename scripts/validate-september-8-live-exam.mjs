...
assert.equal(exam.endsAt, Date.UTC(2026, 8, 9, 10, 0), 'Exam must remain open until 16:00 Asia/Dhaka the next day')
...
console.log('✓ 8 September live exam validated: source-only 83-question PDF paper, 30 / 30 / 23 split, deterministic shuffle, one-paragraph explanations, 23:30–16:00 next-day Asia/Dhaka availability, and restricted admin test access.')
