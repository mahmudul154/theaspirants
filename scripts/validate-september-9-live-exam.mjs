...
assert.equal(scheduledExam.endsAt, Date.UTC(2026, 8, 10, 10, 0), 'Day 3 must remain open until 16:00 Asia/Dhaka the next day')
...
console.log('✓ 9 September live exam validated: source-only 76-question paper, 30 / 30 / 16 split, one-paragraph explanations, fixed shared shuffle, and 23:30–16:00 next-day Asia/Dhaka availability.')
