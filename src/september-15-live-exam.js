...
// Distribution: ইংরেজি ৩০ • আন্তর্জাতিক ৫০ (প্রতি টপিকে ১০) • গণিত ২০
...
const sourceRows = [
  ...
  q('আন্তর্জাতিক বিষয়াবলি', 'পাক-ভারত যুদ্ধ', 'লাহোর ঘোষণা স্বাক্ষরিত হয় —', ['1998', '1999', '2000', '2001'], 1, '21 ফেব্রুয়ারি 1999। নওয়াজ শরীফ ও অটল বিহারী বাজপেয়ীর মধ্যে।'),
  ...
  q('আন্তর্জাতিক বিষয়াবলি', 'ভিয়েতনাম যুদ্ধ', 'Agent Orange কী?', ['রাসায়নিক অস্ত্র/বিষ', 'গোয়েন্দা কোড', 'বিমানের নাম', 'ঘাঁটির নাম'], 0, 'জঙ্গল নিধনে ব্যবহৃত বিষাক্ত রাসায়নিক।'),
  ...
  q('আন্তর্জাতিক বিষয়াবলি', 'আরব-ইসরাইল যুদ্ধ', 'PLO গঠিত হয় —', ['1964', '1967', '1969', '1974'], 0, '1964 সালে আরব লীগের উদ্যোগে।'),
  ...
  q('আন্তর্জাতিক বিষয়াবলি', 'রুশ ও চীন বিপ্লব', 'Great Leap Forward ছিল —', ['শিল্প ও কৃষি উৎপাদন বৃদ্ধির কর্মসূচি', 'সামরিক অভিযান', 'শিক্ষা সংস্কার', 'পররাষ্ট্রনীতি'], 0, '1958-62। ব্যর্থতায় দুর্ভিক্ষ হয়।'),
  ...
  q('আন্তর্জাতিক বিষয়াবলি', 'আরব বসন্ত', 'ইয়েমেনে আরব বসন্তে প্রেসিডেন্ট সালেহ পদত্যাগ করেন —', ['2011', '2012', '2013', '2014'], 1, 'ফেব্রুয়ারি 2012।'),
...
if (SEPTEMBER_15_LIVE_EXAM_COUNTS.total !== 100 || SEPTEMBER_15_LIVE_EXAM_COUNTS.english !== 30 || SEPTEMBER_15_LIVE_EXAM_COUNTS.math !== 20 || SEPTEMBER_15_LIVE_EXAM_COUNTS.generalKnowledge !== 50 || SEPTEMBER_15_LIVE_EXAM_QUESTIONS.some(question => !question.explanation || question.options[question.answer_index] !== question.answer)) {
