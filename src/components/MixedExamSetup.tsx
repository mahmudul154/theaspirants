...
const iconMap: { [key: string]: { emoji: string, color: string, bg: string } } = {
  ...
  "বাংলাদেশ বিষয়াবলি": { emoji: "🗺️", color: "text-orange-600"},
  "আন্তর্জাতিক বিষয়াবলি": { emoji: "🌍", color: "text-sky-600"},
...
"সন্ধি":1000,
    ...
    "বাংলাদেশ বিষয়াবলি":25000,
    "আন্তর্জাতিক বিষয়াবলি":15000,
...
export    const getExamTagsForSubject = (subject) => {
  const examMap = {
    ...
    "বাংলাদেশ বিষয়াবলি":["BCS", "NTRCA", "Primary","Bank","General"],
    "আন্তর্জাতিক বিষয়াবলি":["BCS", "NTRCA", "Primary","Bank","General"],
...
'English': ["Grammar","Parts of Speech","Noun","Pronoun","Number","Gender","Articles","Adjective","Adverb","Verb","Right Form of Verb","Tense","Subject-Verb Agreement","Voice, Narration and One Word","Preposition","Clause","Sentence","Correction","Suffix Prefix","Words","Vocabulary","Synonym & Antonym","Idioms & Phrases","Proverb","Analogy","English Literature","Old English Period","Middle English Period","Renaissance Period","Elizabethan Age","Jacobean Age","Caroline Age","Commonwealth Period","Restoration Period","Augustan Period","Age of Sensibility","Romantic Period","Victorian Period","Modern Period","Post Modern Period","Major Writers of Different Countries","Real and Pen name of the Some Famous Writer","Titles/Titular Names of the Some Famous Writer","Some Famous Books and Writers","Some Important Books and Characters","Main Themes of Some Famous Book","Genres of Literature","Important Literary Quotes","Noble Laureates in English Literature","Text Books Important English Literature","Some Books Banned by Government","BCS","বিবিধ"],
    ...
    "প্রাচীন বাংলার ইতিহাস", "প্রাচীন ইতিহাস ও ঐতিহ্য", "ইউরোপীয় বণিকদের বাংলায় আগমন", "মুসলিম শাসন", 

    // ২. ব্রিটিশ আমল ও স্বাধিকার আন্দোলন
    "ব্রিটিশ শাসন ও আন্দোলন", "ভাষা আন্দোলন", "পাকিস্তান আমলে বাংলাদেশ (১৯৪৭-১৯৭১)", 

    // ৩. মুক্তিযুদ্ধ ও স্বাধীনতা
    "মুক্তিযুদ্ধ ও স্বাধীনতা", "মুক্তিযুদ্ধের পরবর্তী ইতিহাস", "সশস্ত্র বাহিনী", 

    // ৪. সরকার, প্রশাসন ও সংবিধান
    "সংবিধান", "সরকার ও প্রশাসন", "রাজনৈতিক ব্যবস্থা", "সামরিক প্রশাসন", "পাকিস্তানের গণপরিষদ", "পার্লামেন্টারি শব্দকোষ", "বঙ্গীয় মন্ত্রিসভা", "নাথান কমিশন", 

    // ৫. অর্থনীতি, শিল্প ও বাণিজ্য
    "জাতীয় অর্থনীতি", "শিল্প ও বাণিজ্য", "ব্যাংকিং ও আর্থিক ব্যবস্থা", "কৃষি", "খনিজ ও শক্তি সম্পদ", "প্রাণিসম্পদ", "বনজ সম্পদ", "মৎস্য ও জলজ সম্পদ", "যোগাযোগ ব্যবস্থা", 

    // ৬. জনসংখ্যা, সমাজ ও সংস্কৃতি
    "জনসংখ্যা", "জাতিগত গোষ্ঠী", "সমাজ ও সংস্কৃতি", "সাহিত্য ও সংস্কৃতি", "শিল্প, সংস্কৃতি ও স্থপতি", "ইতিহাসে ঢাকা", "শিক্ষা", "সাক্ষরতা আন্দোলন", "স্বাস্থ্য ও সমাজকল্যাণ", 

    // ৭. বিজ্ঞান, প্রযুক্তি ও অন্যান্য
    "বিজ্ঞান ও প্রযুক্তি", "ক্রীড়া ও পর্যটন", "উপমহাদেশে ভ্রমণকারী", "আন্তর্জাতিক প্রেক্ষাপট", "দেশ, রাজধানী, মুদ্রা ও ভাষা", "জাতীয় প্রতীক ও দিবস", "বাংলাদেশের গণমাধ্যম", "বাংলাদেশের প্রথম", "ভূ-রাজনীতি, যুদ্ধ ও ইতিহাস", "ভূগোল ও পরিবেশ", "ব্যক্তিত্ব ও সম্মাননা", "সাম্প্রতিক", "বিবিধ ও মিসলেনিয়াস", "জাতীয় বিষয়াবলি (অন্যান্য)"
],
...
"বিসিএস আন্তর্জাতিক বিষয়াবলি"
    ...
    "ভূতত্ত্ব ও ভূমিরূপ",
    "ভূমিকম্প",
    "নদী, সমুদ্র, প্রণালী ও জলপথ",
    "বাংলাদেশের ভূপ্রকৃতি",
    "উপকূল ও বনজ সম্পদ",
    "বায়ুমণ্ডল, আবহাওয়া ও জলবায়ু",
    "ঘূর্ণিঝড়, ঝড় ও বজ্রপাত",
    "বন্যা, সুনামি ও দুর্যোগ ব্যবস্থাপনা",
...
"আধুনিক প্রযুক্তি",
 ...
 'পদার্থবিজ্ঞান' ,'রসায়ন' ,'জীব বিজ্ঞান' ,'সাধারণ বিজ্ঞান','বিসিএস প্রশ্নব্যাংক'
  ...
  if (category === "bcs") {
    return ["English", "বাংলা", "বাংলাদেশ বিষয়াবলি", "আন্তর্জাতিক বিষয়াবলি", "ভূগোল, পরিবেশ ও দুর্যোগ ব্যবস্থাপনা","নৈতিকতা, মূল্যবোধ ও সুশাসন" , "গাণিতিক যুক্তি","মানসিক দক্ষতা","কম্পিউটার ও তথ্য প্রযুক্তি", "বিজ্ঞান"];
  }
